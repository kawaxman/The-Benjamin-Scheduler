...
class ChangeRegister: UIViewController {
    ...
    var success = UIAlertView(title: "Schedule Change Success.", message: "You have successfully changd your schedule.", delegate: nil, cancelButtonTitle: "Dismiss") //Default Network Error Alert
    ...
    func startParse() {
        ...
        if(statusCode == 300){
            ...
            let ScheduleView = self.storyboard?.instantiateViewControllerWithIdentifier("ScheduleVewController") as? ScheduleViewController
            ...
            let ScheduleView = self.storyboard?.instantiateViewControllerWithIdentifier("ScheduleViewController") as? ScheduleViewController
            self.presentViewController(ScheduleView!, animated: true, completion: nil) //If Success, move to the Main Tab
